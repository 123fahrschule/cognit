defmodule Storybook.CognitComponents.Accordion do
  @moduledoc false
  use PhoenixStorybook.Story, :component

  def function, do: &Cognit.Accordion.accordion/1

  def imports,
    do: [
      {Cognit.Accordion, [accordion_item: 1, accordion_trigger: 1, accordion_content: 1]},
      {Cognit.Button, [button: 1]},
      {Cognit.Input, input: 1},
