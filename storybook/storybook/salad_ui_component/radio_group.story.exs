defmodule Storybook.CognitComponents.RadioGroup do
  @moduledoc false
  use PhoenixStorybook.Story, :component

  def function, do: &Cognit.RadioGroup.radio_group/1
  def imports, do: [{Cognit.Label, [{:label, 1}]}, {Cognit.RadioGroup, [radio_group_item: 1]}]
