defmodule Storybook.CognitComponents.HoverCard do
  @moduledoc false
  use PhoenixStorybook.Story, :component

  alias Cognit.HoverCard

  def function, do: &HoverCard.hover_card/1

  def imports,
    do: [
      {Cognit.HoverCard, [hover_card_trigger: 1, hover_card_content: 1]},
          ...
          <.hover_card_content side="left" align="center">
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <h4 class="text-sm font-semibold">Cognit Package</h4>
