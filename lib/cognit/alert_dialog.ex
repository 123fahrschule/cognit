defmodule Cognit.AlertDialog do
  @moduledoc """
  ...
  * `:class` - Additional CSS classes.
  ...
  def alert_dialog_content(assigns) do
    ...
    <div data-part="content" tabindex="0" hidden class="z-50">
      <div
        data-part="overlay"
        class="fixed inset-0 bg-overlay data-[state=open]/dialog:animate-in data-[state=closed]/dialog:animate-out data-[state=closed]/dialog:fade-out-0 data-[state=open]/dialog:fade-in-0 z-50"
      />
      <div
