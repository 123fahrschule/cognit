defmodule Cognit.Pagination do
  @moduledoc """
  ...
  * `:size` - Link size variant (default, sm, lg, icon)
  ...
  def pagination_link(assigns) do
    ...
    <.link
      ...
      class={
        classes([
          "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50",
          @variation_class,
          @class
        ])
      }
