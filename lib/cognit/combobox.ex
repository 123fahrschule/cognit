defmodule Cognit.Combobox do
  ...
  def combobox_value(assigns) do
    ...
    <span
      data-part="value"
      class={classes(["combobox-value pointer-events-none min-w-0 flex-1 text-start", @class])}
  ...
  def combobox_item(assigns) do
    ...
    <div
      ...
      class={
        classes([
          "relative flex w-full cursor-default select-none items-center gap-2 rounded-sm py-1.5 px-2 text-sm outline-none data-[visible=false]:hidden data-[highlighted=true]:bg-accent data-[highlighted=true]:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
          @class
        ])
      }
