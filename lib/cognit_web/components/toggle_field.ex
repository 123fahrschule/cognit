defmodule CognitWeb.Components.ToggleField do
  @moduledoc """
  CognitWeb.Components.ToggleField component renders a toggle field with customizable options.
  ...
  def toggle_field(assigns) do
    ...
    <div class={[
      ...
      <label for={@id} class={["flex items-center cursor-pointer select-none w-fit", @toggle_wrapper_class]}>
