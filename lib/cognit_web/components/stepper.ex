defmodule CognitWeb.Components.Stepper do
  @moduledoc """
  The `CognitWeb.Components.Stepper` module provides a flexible and interactive stepper component
  ...
  The `CognitWeb.Components.Stepper` enhances user experience by providing a clear and concise representation
