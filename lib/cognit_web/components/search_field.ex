defmodule CognitWeb.Components.SearchField do
  @moduledoc """
  The `CognitWeb.Components.SearchField` module provides a highly customizable search input
  ...
  def search_field(%{floating: floating} = assigns) when floating in ["inner", "outer"] do
    ...
    <div class={[
      ...
      <div class={[
        ...
        <div :if={@search_button} class={["flex items-center justify-center shrink-0 pe-2", @search_button_class]}>
