defmodule CognitWeb.Components.Menu do
  @moduledoc """
  The `CognitWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `CognitWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import CognitWeb.Components.Accordion, only: [accordion: 1]
  import CognitWeb.Components.Button, only: [button_link: 1]
