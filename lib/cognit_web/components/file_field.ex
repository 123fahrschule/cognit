defmodule CognitWeb.Components.FileField do
  @moduledoc """
  The `CognitWeb.Components.FileField` module provides a versatile and customizable component
  ...
  import CognitWeb.Components.Progress, only: [progress: 1]
