defmodule CognitWeb.Components.Combobox do
  @moduledoc """
  The `CognitWeb.Components.Combobox` is a Phoenix LiveView component module for creating customizable combobox elements.
    ...
    <div class={[
      ...
      <div phx-hook="Combobox" data-multiple={@multiple} id={"#{@id}-combo"}>
        ...
        <div phx-update="ignore" id={"#{@id}-combo-wrapper"} class="relative">
          <button class="combobox-trigger w-full text-start py-1 flex items-center justify-between focus:outline-none border" role="combobox" aria-haspopup="listbox" aria-expanded="false" aria-controls={"#{@id}-listbox"} aria-labelledby={"#{@id}-label #{@id}-button"} type="button">
