defmodule CognitWeb.Components.Card do
  @moduledoc """
  Provides a set of card components for the `CognitWeb.Components.Card` project. These components
  ...
  def card_title(assigns) do
    ...
    <div
      ...
      {@rest}
    >
      <div :if={@title || @icon} class="flex gap-2 items-center" aria-labelledby={if @title && @id, do: "#{@id}-title"}>
