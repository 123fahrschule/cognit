defmodule CognitWeb.Components.PasswordField do
  @moduledoc """
  The `CognitWeb.Components.PasswordField` module is a Phoenix component designed to render a customizable
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(CognitWeb.Components.PasswordField.Gettext, "errors", msg, opts)
    end
  end
end
