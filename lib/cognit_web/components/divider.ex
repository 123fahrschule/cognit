defmodule CognitWeb.Components.Divider do
  @moduledoc """
  The `CognitWeb.Components.Divider` module provides a versatile and customizable divider
  ...
  @doc """
  `CognitWeb.Components.Divider.hr` is used to create a horizontal divider with customizable style, color,
  and size options.
