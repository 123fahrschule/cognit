defmodule CognitWeb.Components.Banner do
  @moduledoc """
  CognitWeb.Components.Banner module provides components for rendering customizable banners in your **Phoenix LiveView**
  application.
  ...
  def banner(assigns) do
    ...
    >
      <div class={["flex gap-2 items-center justify-between", @content_wrapper_class]}>
        ...
        <.banner_dismiss :if={!@hide_dismiss} id={@id} dismiss_size={@dismiss_size} class={@dismiss_class} params={@params} />
      </div>
    </div>
    """
  end
