defmodule CognitWeb.Components.NativeSelect do
  @moduledoc """
  The `CognitWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `CognitWeb.Components.NativeSelect`
