defmodule CognitWeb.Components.Overlay do
  @moduledoc """
  The `CognitWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `CognitWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
