defmodule CognitWeb.Components.ScrollArea do
  @moduledoc """
  The `CognitWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
