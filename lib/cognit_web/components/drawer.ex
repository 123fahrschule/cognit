defmodule CognitWeb.Components.Drawer do
  @moduledoc """
  The `CognitWeb.Components.Drawer` module provides a flexible and customizable drawer component
  ...
  def drawer(assigns) do
    ...
    >
      <div
        class={["fixed bg-black/60 inset-0 -z-10 transition-all duration-[0.4s] delay-[0.1s] ease-in-out drawer-overlay", @overlay_class]}
        role="presentation"
        aria-hidden="true"
      ></div>
