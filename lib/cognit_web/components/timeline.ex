defmodule CognitWeb.Components.Timeline do
  @moduledoc """
  The `CognitWeb.Components.Timeline` module is a versatile and customizable component
    ...
    >
      <div :if={!@image} class={["flex items-center", @bullet_wrapper_Class]}>
        <div class={[
          ...
          <.icon :if={@bullet_icon} name={@bullet_icon} class={["bullet-icon", @icon_class]} aria-hidden="true" />
        </div>
        <div class={[
  ...
  def timeline_section(assigns) do
    ...
    >
      ...
      >
        <div class={["timeline-bullet-wrapper relative z-10 size-7 flex justify-center", @bullte_wrapper_class]}>
          <div class={[
