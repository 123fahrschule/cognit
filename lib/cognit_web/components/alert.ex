defmodule CognitWeb.Components.Alert do
  @moduledoc """
  CognitWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
