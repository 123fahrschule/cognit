defmodule CognitWeb.Components.Spinner do
  @moduledoc """
  The `CognitWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `CognitWeb.Components.Spinner` module enables developers to provide
