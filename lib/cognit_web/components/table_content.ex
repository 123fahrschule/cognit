defmodule CognitWeb.Components.TableContent do
  @moduledoc """
  `CognitWeb.Components.TableContent` is a component module designed to create flexible and dynamic
  ...
  def table_content(assigns) do
    ...
    <div
      ...
      {@rest}
    >
    <h5 class={["font-semibold text-sm leading-6", @title_class]}  id={@title&& @id && "#{@id}-title"}>{@title}</h5>
